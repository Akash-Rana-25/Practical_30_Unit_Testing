...
namespace MsUnitTest
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void GetById_ExistingIdPassed_ReturnsEmployee()
        ...
        public void Post_ValidEmployeePassed_ReturnesCreatedResultWithEmployee()
        {
            ...
            Assert.AreEqual("Akash Rana", item?.Name);
        }
        ...
        {
            //Arrange
            Employee employee = new Employee { Id =1, Name = "Akash Rana", Email = "Akash@gmail.com", Address = "Bandhni" };
